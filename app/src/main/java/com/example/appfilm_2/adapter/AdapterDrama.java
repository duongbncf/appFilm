...
public class AdapterDrama extends RecyclerView.Adapter<AdapterDrama.DramaViewHolder> {
    ...
    public AdapterDrama( Context context) {
...
//    }
    ...
    @NonNull
    @Override
    public AdapterDrama.DramaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_movie, parent, false);
        return new AdapterDrama.DramaViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterDrama.DramaViewHolder holder, int position) {
