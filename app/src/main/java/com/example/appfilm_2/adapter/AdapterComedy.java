...
import java.util.ArrayList;
    ...
    public class AdapterComedy extends RecyclerView.Adapter<com.example.appfilm_2.adapter.AdapterComedy.ComedyViewHolder> {
        ...
        public AdapterComedy( Context context) {
...
//    }
        ...
        @NonNull
        @Override
        public com.example.appfilm_2.adapter.AdapterComedy.ComedyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_movie, parent, false);
            return new com.example.appfilm_2.adapter.AdapterComedy.ComedyViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull com.example.appfilm_2.adapter.AdapterComedy.ComedyViewHolder holder, int position) {
        ...
        public class ComedyViewHolder extends RecyclerView.ViewHolder {
            ...
            public ComedyViewHolder(@NonNull View itemView) {
                super(itemView);
