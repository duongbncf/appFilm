...
public class AdapterSport extends RecyclerView.Adapter<AdapterSport.SportViewHolder> {
...
//    }
    ...
    @NonNull
    @Override
    public AdapterSport.SportViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_movie, parent, false);
        return new AdapterSport.SportViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterSport.SportViewHolder holder, int position) {
